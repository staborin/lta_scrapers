...
def login_if_needed(page):
    username = os.environ.get("LUKA_LTA_USERNAME", "").strip()
    password = os.environ.get("LUKA_LTA_PASSWORD", "").strip()

    if not username or not password:
        print("\n⏸️  Env vars not set: LUKA_LTA_USERNAME / LUKA_LTA_PASSWORD")
...
def enrich_tournament_with_my_entry_event(page, tournament):
    """
    Open tournament page, click 'My Entry', and extract the entered event code (e.g. '9U BS', '14U GS').
